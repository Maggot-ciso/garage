  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
      <h2 className="section-title flex items-center gap-2">
        <Fuel className="h-4 w-4" strokeWidth={1.8} aria-hidden /> Quick fill-up
      </h2>
      ...
      <label className="flex flex-col gap-1">
        ...
        />
        {errors.odometer && <span role="alert" className="error-text">{errors.odometer}</span>}
        {!errors.odometer && odoNote && (
          <span className="text-sm text-amber-700 dark:text-amber-400">{odoNote}</span>
        )}
      </label>
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="flex flex-col gap-1">
          ...
          />
          {errors.litres && <span role="alert" className="error-text">{errors.litres}</span>}
        </label>
        <label className="flex flex-col gap-1">
          ...
          />
          {errors.cost && <span role="alert" className="error-text">{errors.cost}</span>}
        </label>
      </div>
      ...
      <label className="card flex items-center gap-3 p-3">
        ...
        <span>
          ...
          <span className="faint block text-sm">Needed for accurate fuel economy</span>
        </span>
      </label>

      <div className="mt-1 flex flex-col gap-2">
        <button type="submit" className="btn-primary">Save fill-up</button>
